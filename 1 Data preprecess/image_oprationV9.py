...
all_folder_name = ['2x2 P1 40-120', '2x2 P1 161-240', '2x2 P1 281-360',
                   '5x5 P1 400-480', '5x5 P2 520-600', '5x5 P3 640-720',
                   '10x10 P1 760-840', '10x10 P2 880-960', '10x10 P3 1000-1080']
layer_num_of_each_folder = [['114', '115', '116', '117', '118', '119'],
...
for folder_name in all_folder_name:
    for layer_num in layer_num_of_each_folder[i]:
        main_path = 'E:/Thesis/code/pre_process2/V9 BA Peltzer/' + folder_name + '/' + layer_num
        k = 0
        ...
        # real_image_array.save(('E:/Thesis/code/pre_process2/V9 BA Peltzer/' + layer_num + '.png'))
        ...
        background1.save(('E:/Thesis/code/pre_process2/V9 BA Peltzer/' + '4V9up_left' + layer_num + '.png'))
        background2.save(('E:/Thesis/code/pre_process2/V9 BA Peltzer/' + '4V9up_right' + layer_num + '.png'))
        background3.save(('E:/Thesis/code/pre_process2/V9 BA Peltzer/' + '4V9bottom_left' + layer_num + '.png'))
        background4.save(('E:/Thesis/code/pre_process2/V9 BA Peltzer/' + '4V9bottom_right' + layer_num + '.png'))
    i = i + 1
